...
DATABASES = {
    'default': {
        ...
        'NAME': 'kuuberhu_HID',          # Name of your database
        'USER': 'kuuberhu_ayushman',               # MySQL user
        'PASSWORD': 'ayush79*',           # MySQL user's password
        'HOST': '65.109.17.97',                   # Set to 'localhost' or your database host IP
...
AUTHENTICATION_BACKENDS = [
    ...
    'authentication.backends.HidPinBackend',  # Add the custom HID and PIN backend
]